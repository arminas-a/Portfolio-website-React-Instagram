  ...
  <div className="about">
    ...
    >
      <div className="about-us">
        <h2>About</h2>
        <p>Here is my background story.</p>
        <br />
      </div>
      <div className="about-content">
        ...
        <article>
          ...
          <p>
            ...
            voluptate maiores ratione quas exercitationem quia odit dicta
            excepturi, debitis, nihil suscipit cumque repellat? Unde optio eos
            incidunt molestias odit, ipsum deserunt eligendi blanditiis fugiat
            minus ratione corporis soluta dolorum nulla?
          </p>
        </article>
        <article>
          <h3>Education</h3>
